...
public class Eleicao {
    public static void main(String[] args) {
        ...
        if (totalVotos > 0) {
            ...
            System.out.println("Candidato A: " + candidatoA + " voto(s). " + String.format("%.2f", porcentagemCandidatoA) + " % do total");
            System.out.println("Candidato B: " + candidatoB + " voto(s). " + String.format("%.2f", porcentagemCandidatoB) + " % do total");
            System.out.println("Brancos: " + brancos + " voto(s). " + String.format("%.2f", porcentagemBrancos) + " % do total");
            System.out.println("Nulos: " + nulos + " voto(s). " + String.format("%.2f", porcentagemNulos) + " % do total");
        }
